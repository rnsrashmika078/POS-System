...
const OrderSummary = () => {
  ...
  return (
    <div>
      <div className="text-[var(--foreground)] bg-[var(--background)] border-[var(--border-color)] rounded-t-xl overflow-y-hidden shadow-xs">
        <div className="p-2 flex overflow-y-auto justify-between rounded-t-xl border bg-[var(--main-background)]   border-[var(--border-color)] shadow-md sticky top-0">
          <CgClose onClick={() => setActiveOrderBar(false)} />
          <p>Order Summary</p>
          <p>#B12309</p>
        </div>
        ...
        <div className="h-[550px] bottom-0 overflow-y-auto">
          <TotalSummary />
        </div>
      </div>
    </div>
      ...
      {products?.map((item, i) => (
        ...
        >
          ...
          <div className="flex flex-col w-full ">
            ...
            <p className="mb-8 text-xs text-gray-500">Size: {`${item.size}`}</p>
    ...
    <div className=" mt-2 p-2 overflow-hidden h-full text-sm">
      <div className="flex flex-col border border-[var(--border-color)] rounded-xl p-2 space-y-2 shadow-md">
        ...
        <div className="flex justify-between">
          ...
          <p className=" font-bold text-red-500">Rs {price?.totalPayment}</p>
        </div>
